...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        $purl = $this->GetCurUrl();
        $maininfo = "<span class=\"current\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span>\r\n";
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<span class=\"current\">共 1 页/".$this->TotalResult." 条记录</span>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<span class=\"current\">共 0 页/".$this->TotalResult." 条记录</span>\r\n";
        }
        $maininfo = "<span class=\"current\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span>\r\n";
